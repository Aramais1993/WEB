...
$works = [
    [
        "name" => "Тренер по Армейскому рукопашному бою",
        "dateStart" => "март 2019",
        "dateEnd" => "по настоящее время",
        "description" => "Работаю тренером армейского рукопашного боя, обучаю детей возрастом 7-14лет",
    ],
    [
      "name" => "МВД России",
      "dateStart" => "Август 2020",
      "dateEnd" => "Июль 2023",
      "description" => "Работал в отделе экономической безопасности и противодействия коруппции". 
      " В  мои обязанности входило борьба с хищением, мошенничеством, противозаконной предпринимательской деятельностью, взяточничеством и прочими нарушениями",
  ],
];
      ...
      <div class="w3-third">
        <div class="w3-white w3-text-grey w3-card-4">
          ...
          <div class="w3-container">
            <p><i class="fa fa-briefcase fa-fw w3-margin-right w3-large w3-text-teal"></i>Тренер</p>
